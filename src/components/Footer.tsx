    ...
    <footer className="w-full bg-gray-50 py-24">
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <Link to="/" className="text-2xl font-medium text-gray-900 block mb-4">
              Voxed
            </Link>
            <p className="text-gray-600 mb-6">
              Your data-powered research team
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li>
                <Link to="https://aaxiom.org" className="hover:text-gray-900">About</Link>
              </li>
              <li>
                <Link to="https://aidanandrews.info" className="hover:text-gray-900">Team</Link>
              </li>
              {/* <li>
                <Link to="/careers" className="hover:text-gray-900">Careers</Link>
              </li> */}
              <li>
                <button onClick={() => scrollToSection('demo')} className="hover:text-gray-900">Contact</button>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li>
                <Link to="/research" className="hover:text-gray-900">Research</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li>
                <Link to="https://github.com/AAxiom-org/VoxedAI-frontend/blob/production/LICENSE" className="hover:text-gray-900">License</Link>
              </li>
              {/* <li>
        ...
        <div className="border-t border-gray-200 mt-16 pt-8 text-center text-gray-600">
          <p>© {new Date().getFullYear()} Voxed.ai. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
