      ...
      <section className="py-20 text-center relative z-2">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold mb-6 gradient-primary-to-indigo bg-clip-text text-transparent">
            Transform How You Work, Learn, and Create
          </h2>
    
          <p className="color-secondary mx-auto mb-8 leading-relaxed">
            Whether you're tackling academic research, building coding projects, or organizing lecture notes,
            our intelligent workspace streamlines your workflow and amplifies your creativity. 
            Join thousands of students and professionals enhancing their productivity with one powerful platform.
          </p>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-8">
            <div className="flex items-center">
              <div className="bg-secondary p-2 rounded-full border border-adaptive mr-4">
              ...
              <div className="text-left">
                <h3 className="text-lg font-medium color-primary">Quick Setup</h3>
                <p className="color-secondary text-sm">Get started in minutes</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="text-left">
                <h3 className="text-lg font-medium color-primary">Intuitive Interface</h3>
                <p className="color-secondary text-sm">No learning curve</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="text-left">
                <h3 className="text-lg font-medium color-primary">AI-Powered</h3>
                <p className="color-secondary text-sm">Smart workspaces</p>
              </div>
            </div>
          </div>
        </div>
